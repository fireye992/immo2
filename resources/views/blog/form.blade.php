<form action="" method="post" class="mt-6">
    ...
    <div>
        ...
        <input type="text", id="slug" value="{{ old('slug', $post->slug) }}"
            class="block w-full px-4 py-2 mt-2 text-purple-700 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40">
        @error('slug')
            <div class="inline-flex text-sm text-red-700"> {{ $message }}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
    ...
    <div>
        ...
        <textarea name="content"
            class="block w-full px-4 py-2 mt-2 text-purple-700 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40">{{ old('content', $post->content) }}</textarea>
        @error('content')
            <div class="inline-flex text-sm text-red-700"> {{ $message }}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
